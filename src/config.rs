...
impl Default for KeyConfig {
    fn default() -> Self {
        Self {
            ...
            quit: Key::Char('q'),
            exit_popup: Key::Esc,
            focus_right: Key::Alt('r'),
            focus_left: Key::Alt('l'),
            focus_above: Key::Up,
            ...
            extend_or_shorten_widget_width_to_right: Key::Ctrl('>'),
            extend_or_shorten_widget_width_to_left: Key::Ctrl('<'),
        }
    }
}
